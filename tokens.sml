 ...
 * 
 * Description: Contains the Token structure which implements the Tiger_TOKENS
 *              signature and provides debugging information about the Tokens
 *              generated through lexing.
 ******************************************************************************)
...
struct
  ...
  fun INT (c, i, j)     = "INT ("           ^ Int.toString c ^ ")   " 
                                            ^ Int.toString i
